...
exports.options = exports.remove = exports.update = exports.create = exports.byId = exports.adminList = void 0;
const req_1 = require("@/utils/req");
const async_handler_1 = require("@/utils/async-handler");
const api_response_1 = require("@/utils/api-response");
const service = __importStar(require("./return-policy.service"));
...
exports.byId = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const p = await service.byId((0, req_1.param)(req, 'id'));
    return res.json(p);
});
...
exports.update = (0, async_handler_1.asyncHandler)(async (req, res) => {
    ...
    return (0, api_response_1.sendOk)(res, { message: 'Return policy updated successfully', data });
});
exports.remove = (0, async_handler_1.asyncHandler)(async (req, res) => {
    await service.remove((0, req_1.param)(req, 'id'));
    return (0, api_response_1.sendOk)(res, { message: 'Return policy deleted successfully' });
});
...
//# sourceMappingURL=return-policy.controller.js.map