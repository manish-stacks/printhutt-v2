...
exports.getCustomerEmailTemplate = getCustomerEmailTemplate;
function getCustomerEmailTemplate({ orderId, items, totalAmount, payment, shipping, coupon, formatCurrency, paymentType, payAmt }) {
                          ...
                          <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td style="padding: 8px 0; text-align: right; color: #111827; font-weight: 600;">
                                ${formatCurrency((totalAmount.discountPrice + totalAmount.shippingTotal) - (totalAmount.coupon_discount || 0))}
                              </td>
                            </tr>
                            ${paymentType === 'offline' ? `
                              <tr>
