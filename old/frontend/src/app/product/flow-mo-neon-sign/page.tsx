...
import { NeonText } from '@/components/flowmo-neon/NeonText';
// import { ColorPicker } from '@/components/flowmo-neon/ColorPicker';
import { FontPicker } from '@/components/flowmo-neon/FontPicker';
import { SizePresets } from '@/components/flowmo-neon/SizePresets';
// import { StyleSelector } from '@/components/flowmo-neon/StyleSelector';
import { PreviewGallery } from '@/components/flowmo-neon/PreviewGallery';
...
export default function NeonPage() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const fetchedProduct = await get_product_by_id("685e74715b55978073e76588");
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      if (previewCanvas && product) {
        ...
        // console.log("Existing Cart State:", total );
