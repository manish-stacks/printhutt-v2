...
export const blogCategoryService = {
  ...
  create: (formData: any) => axiosInstance.post(`/blog-categories`, formData),
  update: (id: string, formData: any) => axiosInstance.put(`/blog-categories/${id}`, formData),
...
export const blogService = {
  ...
  create: (formData: any) => axiosInstance.post(`/blogs`, formData),
  getBlog: (id: string) => axiosInstance.get(`/blogs/${id}`),
  update: (id: string, formData: any) => axiosInstance.put(`/blogs/${id}`, formData),
