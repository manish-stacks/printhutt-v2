...
export default function Page() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const fetchedProduct = await get_product_by_id("68cbda84a9018a4f263bf26f");
              ...
              <div id="preview-section" className="relative rounded-lg p-2 backdrop-blur-sm border border-white/10">
                <div className="img-box relative">
                  <Image
                    width={800}
                    height={800}
                    src="https://s3.ap-south-1.amazonaws.com/printhutt.dev.bucket/others/kids-lamp/couple-lamp12.jpg"
                    alt="Preview"
