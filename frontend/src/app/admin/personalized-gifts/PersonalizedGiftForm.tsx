...
interface Props {
    editData?: any;
    availableTypes?: { image: boolean; video: boolean };
    onClose: () => void;
}
...
const PersonalizedGiftForm = ({ editData, availableTypes, onClose, }: Props) => {
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <select
                                ...
                                className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-black/10"
                            >
                                <option value="image" disabled={availableTypes && !availableTypes.image}>
                                    Image {availableTypes?.image === false ? '(Limit reached)' : ''}
                                </option>
                                <option value="video" disabled={availableTypes && !availableTypes.video}>
                                    Video {availableTypes?.video === false ? '(Limit reached)' : ''}
                                </option>
                            </select>
                        </div>
                        <div>
