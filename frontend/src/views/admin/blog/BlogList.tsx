...
export default function BlogList() {
  ...
  const lf = useListFilters(blogs as any[], { statusKey: 'status', nameKey: 'title' });
      ...
      <div className="ph-page">
        <div className="w-full md:w-12/12 lg:w-12/12 mb-5">
          <div className="ph-page-head ph-head-card">
            ...
            <div>
              <Link href={'/admin/blogs/add'} className="ph-btn ph-btn-primary">Add</Link>
            </div>
          </div>
        </div>
