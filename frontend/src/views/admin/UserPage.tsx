...
export default function UserPage() {
    ...
    const lf = useListFilters(users as any[], { statusKey: 'isBlocked', statusLabels: ['Blocked', 'Active'], nameKey: 'username', extra: [{ key: 'verified', label: 'Verified', options: [{ value: 'all', label: 'Verified: any' }, { value: 'yes', label: 'Verified' }, { value: 'no', label: 'Unverified' }], test: (r: any, v: string) => !!r.isVerified === (v === 'yes') }] });
